...
class OrganizationAdminRegister(BaseModel):
    ...
    # Admin details
    admin_full_name: str = Field(..., min_length=2, description="Full name of the admin")
    ...
    admin_phone_number: Optional[str] = Field(None, description="Admin phone number (must start with +)")
