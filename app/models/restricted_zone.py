...
import enum
from sqlalchemy import Column, Integer, String, Boolean, DateTime, Enum as SQLAlchemyEnum, Float, JSON, ForeignKey
...
class RestrictedZone(Base):
    ...
    created_by_authority_id = Column(Integer, ForeignKey("users.id", name="fk_nfz_creator_id"), nullable=False)
