...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"], ["users.id"], name="fk_organization_admin_id"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "admin_id"
        ),  # Ensure admin_id is unique if one admin per org
    )
    ...
    op.create_foreign_key(
        "fk_user_organization_id", "users", "organizations", ["organization_id"], ["id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "owner_type",
            sa.Enum("ORGANIZATION", "SOLO_PILOT", name="droneownertype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "current_status",
            sa.Enum("IDLE", "ACTIVE", "MAINTENANCE", "UNKNOWN", name="dronestatus"),
            nullable=False,
        ),
        sa.Column(
            "last_telemetry_id", sa.Integer(), nullable=True
        ),  # FK will be added with use_alter=True
        ...
        sa.ForeignKeyConstraint(
            ["organization_id"], ["organizations.id"], name="fk_drone_organization_id"
        ),
        sa.ForeignKeyConstraint(
            ["solo_owner_user_id"], ["users.id"], name="fk_drone_solo_owner_user_id"
        ),
        # FK for last_telemetry_id is handled by use_alter=True in the model, Alembic adds it later.
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_drones_deleted_at"), "drones", ["deleted_at"], unique=False
    )
    op.create_index(op.f("ix_drones_id"), "drones", ["id"], unique=False)
    op.create_index(
        op.f("ix_drones_serial_number"), "drones", ["serial_number"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "geometry_type",
            sa.Enum("CIRCLE", "POLYGON", name="nfzgeometrytype"),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["created_by_authority_id"], ["users.id"], name="fk_nfz_creator_id"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_restricted_zones_deleted_at"),
        "restricted_zones",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_restricted_zones_id"), "restricted_zones", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_restricted_zones_name"), "restricted_zones", ["name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["approved_by_authority_admin_id"],
            ["users.id"],
            name="fk_flightplan_auth_admin_approver_id",
        ),
        sa.ForeignKeyConstraint(
            ["approved_by_organization_admin_id"],
            ["users.id"],
            name="fk_flightplan_org_admin_approver_id",
        ),
        sa.ForeignKeyConstraint(
            ["drone_id"], ["drones.id"], name="fk_flightplan_drone_id"
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
            name="fk_flightplan_organization_id",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="fk_flightplan_user_id"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_flight_plans_deleted_at"), "flight_plans", ["deleted_at"], unique=False
    )
    ...
    op.create_index(
        "ix_flightplan_drone_id", "flight_plans", ["drone_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["flight_plan_id"],
            ["flight_plans.id"],
            name="fk_waypoint_flightplan_id",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_waypoints_sequence_order"),
        "waypoints",
        ["sequence_order"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_waypoint_flight_plan_id_sequence_order",
        "waypoints",
        ["flight_plan_id", "sequence_order"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["drone_id"],
            ["drones.id"],
            name="fk_telemetry_drone_id",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["flight_plan_id"],
            ["flight_plans.id"],
            name="fk_telemetry_flightplan_id",
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_telemetry_logs_drone_id"), "telemetry_logs", ["drone_id"], unique=False
    )
    op.create_index(
        op.f("ix_telemetry_logs_flight_plan_id"),
        "telemetry_logs",
        ["flight_plan_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_telemetry_logs_id"), "telemetry_logs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_telemetry_logs_timestamp"),
        "telemetry_logs",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        ),  # This implies it inherited Base, but PK should be user_id, drone_id
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
        ...
        sa.ForeignKeyConstraint(
            ["drone_id"], ["drones.id"], name="fk_assignment_drone_id"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="fk_assignment_user_id"
        ),
...
def downgrade() -> None:
    ...
    op.drop_table(
        "user_drone_assignments"
    )  # If it inherited Base and had its own id index: op.drop_index(op.f('ix_user_drone_assignments_id'), table_name='user_drone_assignments')
    ...
    op.drop_table(
        "telemetry_logs"
    )  # Drones might reference this, so needs careful ordering or use_alter
